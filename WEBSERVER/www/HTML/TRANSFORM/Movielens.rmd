...
plot_usmap(data = prova, values = "MeanRating", color = "red") +  scale_fill_continuous( low = "white", high = "red", name = "Mean Rating", label = scales::comma ) + theme(legend.position = "right")
