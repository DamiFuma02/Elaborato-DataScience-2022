...
-   [NETLFIX](./TRANSFORM/Netflix.html#genreAPP): Per ogni Stato Mondiale individuare il genere di film più occorrente

-   i film con più alto gross sono più presenti nelle varie piattaforme netflix, amazon?

-   [APP](./): creare un sistema di raccomandazione dinamico

    -   FILM,SERIE TV o entrambi
...
-   [MOVIELENS](./TRANSFORM/Movielens.html#userLocation): categorizzare i film in base alla location degli user
