...
```{r import}
movies <- read_csv("../CLEAN_DATA/MOVIELENS/movies.csv")
nrow(movies)

ratings <- read_csv("../CLEAN_DATA/MOVIELENS/ratings.csv")
# View(ratings)

users <- read_csv("../CLEAN_DATA/MOVIELENS/users.csv")
# View(users)
...
usermapped = left_join(ratings,users, by = "userID")
