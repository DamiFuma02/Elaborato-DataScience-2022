...
genres = vector(mode = "character")
for (i in 1:nrow(sequels)){
  genres = append(genres,  unlist(str_split(disney$Genres[i],", ")))
}
...
for (i in 1:nrow(disney)){
  countries = append(countries,  unlist(str_split(disney$country[i],", ")))
}
...
genres = vector(mode = "character")
for (i in 1:nrow(sequels)){
  genres = append(genres,  unlist(str_split(HighestGrossers$Genre[i],", ")))
}
...
for (i in 1:nrow(movies)){
  arr = append(arr,  unlist(strsplit(movies$Genres[i],"|",fixed = TRUE)))
}
...
for (i in 1:nrow(netflix)){
  genres = append(genres,  unlist(str_split(netflix$Genres[i],", ")))
}
...
countries = vector(mode = "character")
for (i in 1:nrow(netflix)){
  countries = append(countries,  unlist(str_split(netflix$country[i],", ")))
}
